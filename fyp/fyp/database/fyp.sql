...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2026 at 06:14 PM
...
(6, '$2y$10$.6IshKqQWDKxNNKEzmEVTembb3Z3AD524MYJRxoumU/eBu98jrlGe', 'Sim Heng Jing', 'hengjingchen102@gmail.com', '0137787266', '19 Jalan Eco Cascadia 5/1', 'admin_avatar_6_1780995871.jpg', 'https://calendar.app.google/9n4Vz8ys8n51WdCv9', '2026-06-21 09:18:18'),
(10, '$2y$10$dfE93KztYTa8RjQNOBSZyus1CBDWEngxVJjvn6TzW8A3IRnNaKGQ2', 'Sim Heng Ping', 'simhengping@gmail.com', '0137787266', '19 Jalan Eco Cascadia 5/1', 'admin_avatar_10_1780995883.jpg', 'https://calendar.app.google/Cn9fpqqfKBCHEyGr9', '2026-06-21 09:18:18'),
(11, '$2y$10$Ax5cUn4jTl9X9swTnS206evUC4jGOrMONaGiWBVtUFYeQj9M.4d9q', 'Ng Yong Lok', 'jmslok1234@gmail.com', '0137787266', '19 Jalan Eco Cascadia 5/1', 'admin_avatar_11_1780995894.jpg', 'https://calendar.app.google/sfiWtgpYopYd7Mm47', '2026-06-21 09:18:18');
...
(66, 'Kal', 'hengjingchen102@gmail.com', '0137787266', '20, JALAN SETIA INDAH 12/11, TAMAN SETIA INDAH', 'Male', 'Other', 1, '$2y$10$n73zz4mx3hX6q03q9BCXD.RRJSzo7DOCnX5jsEn54HPGGq7rLUIVi', '2026-06-19 13:46:18', 'uploads/customer_avatars/defaultAvatar_OtherMale.png', '2026-06-22 14:10:53'),
...
(72, 66, 'uploads/payments/1782139967_ErpFYP.drawio.png', '2026-06-22 14:52:47', 'Verified', '', 211, 'final'),
...
INSERT INTO `staff` (`id`, `password`, `staff_name`, `status`, `email`, `phone`, `profile_image`, `appointment_calendar`, `updated_at`) VALUES
(6, '$2y$10$spcAHVGkpSyJVbnFg2wkAOEFGlgB.qTiJzagNY9sHhnKXIpKkdjAC', 'Sim Heng Jing', 1, 'hengjingchen102@gmail.com', '0137787266', '../uploads/staff_avatars/default_avatar.png', 'https://calendar.app.google/G6NyZrMYhSszPmeE6', '2026-06-21 14:24:48'),
(15, '$2y$10$ndvyp/R6tUmqUWGBYDZe7eMAhk.y0CUdilBNBsTuar4d/RiSzzfBe', 'Sim Heng Ping', 1, 'simhengping@gmail.com', '0137519660', 'uploads/staff_avatars/staff_15_1780995786.jpg', 'https://calendar.app.google/Cn9fpqqfKBCHEyGr9', '2026-06-21 09:18:18'),
(18, '$2y$10$JJMcDYaeiG57MiGCfrVj4efZ7IoKFLLwDD3V/1zHr1tf9Xux05C2q', 'Ng Yong Lok', 1, 'jmslok1234@gmail.com', '0104331663', 'uploads/staff_avatars/staff_18_1781769900.jpg', 'https://calendar.app.google/sfiWtgpYopYd7Mm47', '2026-06-21 09:18:18');
...
--
ALTER TABLE `invoices`
  MODIFY `inv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `quotations`
  MODIFY `qtn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=213;

--
-- AUTO_INCREMENT for table `quotation_history`
--
ALTER TABLE `quotation_history`
  MODIFY `history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;

--
-- AUTO_INCREMENT for table `quotation_items`
--
ALTER TABLE `quotation_items`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=495;
