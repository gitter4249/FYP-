...
if (isset($_GET['reset_error'])) {
    $error_message = htmlspecialchars($_GET['reset_error']);
}
if (isset($_GET['msg'])) {
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo-group img { width: 60px; height: auto; border-radius: 8px; }
...
<div class="page-container">
    <div class="login-card" id="card">
        ...
        <p class="subtitle" id="form-subtitle">Administrator Access Portal</p>
        ...
        <form action="admin_login_process.php" method="POST">
            <div id="login-fields">
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="login_email" placeholder="admin@ysaluminium.com" required>
                </div>
                <div class="form-group">
            ...
            <div id="forgot-fields">
                ...
                <button type="submit" name="admin_reset" class="btn">Send New Password</button>
...
<script>
    function toggleMode(isForgot) {
        ...
        if (isForgot) {
            ...
            subtitle.innerText = "Administrator Access Portal";
