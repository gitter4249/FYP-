...
<div class="quotation-container">
    <div class="page-header">
        <a href="admin_dashboard.php?view=quotations_invoices" class="btn-back"><i class="bi bi-arrow-left"></i> Back to Dashboard</a>
        ...
        fetch('generate_quotation_pdf.php', { method: 'POST', body: formData })
            ...
            .then(data => {
                if (data.success) {
                    ...
                    setTimeout(() => window.location.href = 'admin_dashboard.php?view=quotations_invoices', 10000);
                } else {
